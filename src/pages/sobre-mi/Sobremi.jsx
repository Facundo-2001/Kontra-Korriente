  ...
  return (
    <div className="sobre-mi-container" style={{ backgroundImage: `url(${imagen1})` }}>
      <div className="sobre-mi-content">
        <h2>Sobre Mí</h2>
        <p className="intro">
          <strong>Lola Florencia Rodriguez</strong>
        </p>
        <p>
          Docente de teatro formada en la Escuela de Arte 1 Leopoldo Marechal. En el 2017 conformo la Companía de títeres “kontra korriente” paralelamente trabajo en una compania de titiriteros llamada “Títeres andantes”. En el 2018 fue parte de la Cooperativa de titiriteros “Titiriteba”.
        </p>
        <p>
